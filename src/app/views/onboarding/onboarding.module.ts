...
const routes: Routes = [
  ...
  {
    path: "preferences",
    component: OnboardingPreferencesComponent,
  },
  {
    path: "mealpreferences",
    component: OnboardingMealPreferencesComponent,
  },
  {
    path: "ingredientpreferences",
    component: OnboardingIngredientPreferencesComponent,
  },
  {
    path: "loadingscreen",
    component: OnboardingLoadingScreenComponent,
  },
  {
    path: "surprisepreferences",
    component: OnboardingSurprisePreferencesComponent,
  },
  {
    path: "numberofmeals",
    component: OnboardingNumberOfMealsComponent,
  },
  {
    path: "numberofmeals/add",
    component: OnboardingNumberOfMealsComponent,
  },
  {
    path: "complete",
...
@NgModule({
  ...
  entryComponents: [GuidemodalComponent, OnboardingSurprisePreferencesComponent, OnboardingProgressComponent],
})
