...
import { ConfirmmodalComponent } from "src/app/core/components/confirmmodal/confirmmodal.component";
...
@NgModule({
  ...
  entryComponents: [IncompleteReviewModalComponent, ConfirmmodalComponent],
})
